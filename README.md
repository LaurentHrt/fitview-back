...
- The `docker container run --name micro-api -p 3000:3000 -dt micro-api` command will allow you to create your Docker container and run your image on port 3000.
